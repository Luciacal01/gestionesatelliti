				                	...
				                	<c:forEach items="${satellite_list_attribute }" var="satelliteItem">
										<tr>
											...
											<td>
												...
												<a class="btn  btn-sm btn-outline-primary ml-2 mr-2" href="${pageContext.request.contextPath}/satellite/delete/${satelliteItem.id }">Lancia</a>
												<a class="btn  btn-sm btn-outline-primary ml-2 mr-2" href="${pageContext.request.contextPath}/satellite/delete/${satelliteItem.id }">Rientra</a>
											</td>
										</tr>
									</c:forEach>
				                </tbody>
